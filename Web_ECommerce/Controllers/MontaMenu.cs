...
namespace Web_ECommerce.Controllers
{
    public class MontaMenu : BaseController
    {
        ...
        public MontaMenu(UserManager<ApplicationUser> userManager, ILogger<ProdutosController> logger, InterfaceLogSistemaApp InterfaceLogSistemaApp, 
            InterfaceMontaMenu InterfaceMontaMenu) : base(logger, userManager, InterfaceLogSistemaApp)
        {
