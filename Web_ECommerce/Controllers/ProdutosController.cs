...
namespace Web_ECommerce.Controllers
{
    ...
    public class ProdutosController : BaseController
    {
        ...
        public ProdutosController(InterfaceProductApp InterfaceProductApp, UserManager<ApplicationUser> userManager, 
            InterfaceCompraUsuarioApp InterfaceCompraUsuarioApp, ILogger<ProdutosController> logger, 
            InterfaceLogSistemaApp InterfaceLogSistemaApp, IWebHostEnvironment environment)
